...
public class Vec2 {
	...
	final static public boolean watchCreations = false;
	/**
	 * Running count of Vec2 creations. Must be zeroed out manually (perhaps at
	 * start of time step). Incremented in Vec2 constructor if watchCreations
	 * flag is true. <BR>
	 * <BR>
	 * Mainly used for optimization purposes, since temporary Vec2 creation is
	 * often a bottleneck.
	 */
